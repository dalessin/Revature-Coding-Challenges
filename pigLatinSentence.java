...
public class pigLatinSentence {
    ...
    public static void encode(String sentence) {
        ...
        for (String outputLatin : sentence.split(" ")) {
            // append blocks between spaces into stringbuilder, skips first letter (put at
            // end) and adds piglatin
            sb.append(outputLatin.substring(1) + outputLatin.charAt(0) + "ay" + " ");
            // ran out of time trying to find punctuation component, preliminary google
            // findings
            // planning to check stringbuilder-1 result for special character, if found
            // exit, else returns sb
